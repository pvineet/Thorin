...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, t):
        ...
        lookup = self.pretrained_embeddings(t)
        x = lookup.view(lookup.size()[0], lookup.size()[1] * lookup.size()[2])
        ### END YOUR CODE
        return x
    ...
    def forward(self, t):
        ...
        l1 = self.embed_to_hidden(embeddings)
        l2 = F.relu(l1)
        l3 = self.dropout(l2)
        logits = self.hidden_to_logits(l3)
